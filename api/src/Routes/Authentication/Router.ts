...
function ClassMap(userType: string): UserController {// | AdminController {
...
publicAuthenticationRouter.use("/auth", publicAuthenticationRouter);
privateAuthenticationRouter.use("/auth", privateAuthenticationRouter);
